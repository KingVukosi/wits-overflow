...
void main(){
  testWidgets("The sign in screen displays the accurate number of widgets, each with accurate corresponding image/text", (WidgetTester tester) async{
    ...
    final welcomeMessageFinder = find.text("Welcome to Wits Overflow.  The ultimate in high-tech question answering goodness.  Enter for all your knowledge seeking needs.");
    final disclaimerFinder = find.text("Currently we\'re catering exclusively to Wits students (lucky you), so click the button below to sign in with your student gmail account and get started on your journey to unlimited knowledge...");
