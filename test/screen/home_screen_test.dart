...
void main() {
  group("Test Home screen", () {
    ...
    testWidgets('displays question title & body',
      ...
      expect(find.text('Wits Overflow'), findsWidgets);
    });

    testWidgets('Navigate to user info screen',
        (WidgetTester widgetTester) async {
      HomeScreen homeScreen = HomeScreen(
        firestore: firestore,
        auth: auth,
      ...
      // navigate to
      await widgetTester
          .tap(find.byKey(Key('id_drawer_navigate_to_user_profile')));
    });

    testWidgets('Navigate to post question screen',
        (WidgetTester widgetTester) async {
      HomeScreen homeScreen = HomeScreen(
        firestore: firestore,
        auth: auth,
      ...
      // navigate to
      await widgetTester
          .tap(find.byKey(Key('id_drawer_navigate_to_post_question')));
    });

    testWidgets('Navigate to home screen', (WidgetTester widgetTester) async {
      HomeScreen homeScreen = HomeScreen(
        firestore: firestore,
        auth: auth,
      );
    ...
    testWidgets('Navigate to notifications screen',
        (WidgetTester widgetTester) async {
      HomeScreen homeScreen = HomeScreen(
        firestore: firestore,
        auth: auth,
