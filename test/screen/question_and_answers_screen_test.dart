...
void main() {
  group('Test question and answers screen', () {
    ...
    setUp(() async {
      ...
      await firestore.collection(COLLECTIONS['users']).doc(commentUser['uid']).set({
      ...
      await firestore.collection(COLLECTIONS['questions']).doc(question['id'])
      .collection('comments').add(questionComment).then((value){
      ...
      await firestore.collection(COLLECTIONS['users']).doc(answerCommentAuthor['uid']).set({
      ...
      await firestore.collection(COLLECTIONS['questions'])
          .doc(question['id'])
          .collection('answers')
          .doc(answer['id'])
          .collection('comments')
          .add(answerComment).then((value){
    ...
    testWidgets('displays all valid information',
