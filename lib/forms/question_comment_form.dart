...
class QuestionCommentForm extends StatefulWidget {
  ...
  QuestionCommentForm(this.questionId, this.questionTitle, this.questionBody, {firestore, auth}) : this._firestore = firestore == null ? FirebaseFirestore.instance: firestore, this._auth = auth == null ? FirebaseAuth.instance: auth;

  @override
  _QuestionCommentFormState createState() {
    return _QuestionCommentFormState(this.questionId, this.questionTitle, this.questionBody, firestore: this._firestore, auth: this._auth);
  }
}
...
class _QuestionCommentFormState extends State<QuestionCommentForm> {
  ...
  _QuestionCommentFormState(this.questionId, this.questionTitle, this.questionBody, {firestore, auth}){
  ...
  void submitComment(String body) async{
    ...
    Map<String, dynamic>? questionComment = await witsOverflowData.postQuestionComment(questionId: this.questionId, body: body, authorId: authorId);
