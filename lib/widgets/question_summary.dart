...
class QuestionSummary extends StatelessWidget {
  ...
  QuestionSummary({required this.questionId,
    required this.title,
    required this.tags,
    required this.votes,
    ...
    return GestureDetector(
      onTap: (){
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => QuestionAndAnswersScreen(this.questionId)
          )
        );
      },
      child: Center(
        child: Container(
          ...
          child: Row(
            children: [
              Container(
                color: this._hasAcceptedAnswer() == true ? Color.fromRGBO(231, 251, 239, 1) : Colors.grey.shade100,
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        SvgPicture.asset(
                          countVotes(this.votes) < 0 ? 'assets/icons/caret_down.svg' : 'assets/icons/caret_up.svg',
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          ...
                          style: TextStyle(
                            color: this._hasAcceptedAnswer() == true ? Color.fromRGBO(76, 144, 103, 1) : Colors.grey.shade100,
                          ),
                        ),
                        ...
                        SvgPicture.asset(
                          this._hasAcceptedAnswer() == true ? 'assets/icons/question_answer_correct.svg' : 'assets/icons/answer.svg',
                          semanticsLabel: 'Feed button',
                          placeholderBuilder: (context) {
                            return Icon(Icons.error, color: Colors.deepOrange);
                          },
